package cn.ed.qut.compiler.base.objectCodeGeneration;
...
//		}
	...
	public void asmHead(ArrayList<String> id, ArrayList<String> fourElemT) {
		...
		for (int i = 0; i < fourElemList.size(); i++) {
			if(fourElemList.get(i).getOp().equals("PRINTF")){
				...
				asmCodeList.add("printf_"+fourElemList.get(i).getArg1()+(i+1)+" db '"+fourElemList.get(i).getArg1()+":$'");
				
			}else if(fourElemList.get(i).getOp().equals("SCANF")){
				asmCodeList.add("scanf_"+fourElemList.get(i).getArg1()+(i+1)+" db 'input "+fourElemList.get(i).getArg1()+":$'");
			}
		}
	...
	public void asmCode(ArrayList<FourElement> fourElemList) {
		...
		for (int i = 0; i < fourElemList.size(); i++) {
			...
			if (fourElemList.get(i).getArg1().equals(position + 2 + "")) {
			 		
				  if(fourElemList.get(i).getOp().equals("FJ")||fourElemList.get(i).getOp().equals("RJ")){
				      fourElemList.get(i).setArg1("TheEnd");
			    	  flag = 1;
				  }
			} 
			
 
			if (fourElemList.get(i).getOp().equals("=")) {

				asmCodeList.add("L" + (i + 1) + ": mov AX, " + fourElemList.get(i).getArg1());
				asmCodeList.add("mov " + fourElemList.get(i).getResult() + ", AX");
			} else if (fourElemList.get(i).getOp().equals("+")) {

				asmCodeList.add("L" + (i + 1) + ": mov AX, " + fourElemList.get(i).getArg1());
				asmCodeList.add("add AX, " + fourElemList.get(i).getArg2());
				asmCodeList.add("mov " + fourElemList.get(i).getResult() + ", AX");
			}else if (fourElemList.get(i).getOp().equals("++")) {
				...
				asmCodeList.add("L" + (i + 1) + ": mov AX, " + fourElemList.get(i).getArg1());
				asmCodeList.add("sub AX, " + fourElemList.get(i).getArg2());
				asmCodeList.add("mov " + fourElemList.get(i).getResult() + ", AX");
			} else if (fourElemList.get(i).getOp().equals("*")) {

				asmCodeList.add("L" + (i + 1) + ": mov AX, " + fourElemList.get(i).getArg1());
				asmCodeList.add("mov BX," + fourElemList.get(i).getArg2());
			...
			else if (fourElemList.get(i).getOp().equals("FJ")) {

				if (flag == 1) {//如果=1跳到TheEnd,完成运算。
					//jnc:大于或等于则跳转
					asmCodeList.add("L" + (i + 1) + ": jnc " + fourElemList.get(i).getArg1());
				} else {
					asmCodeList.add("L" + (i + 1) + ": jnc L" + fourElemList.get(i).getArg1());

				}

			} else if (fourElemList.get(i).getOp().equals("RJ")) {

				if (flag == 1) {//如果=1跳到TheEnd,完成运算。
					asmCodeList.add("L" + (i + 1) + ": jmp " + fourElemList.get(i).getArg1());
				} else {
					asmCodeList.add("L" + (i + 1) + ": jmp L" + fourElemList.get(i).getArg1());
				...
				asmCodeList.add("L" + (i + 1) + ": mov AX, " + fourElemList.get(i).getArg2());
				asmCodeList.add("sub AX, " + fourElemList.get(i).getArg1());
				...
				asmCodeList.add(" mov AX, " + fourElemList.get(i).getArg2());
				...
				asmCodeList.add("add AX, 1");
				asmCodeList.add( "mov BX ,AX");
				asmCodeList.add(" mov AX, " + fourElemList.get(i).getArg1());
				asmCodeList.add("sub AX, BX");
				
			}
			
			else if (fourElemList.get(i).getOp().equals("PRINTF")) {
				asmCodeList.add("\n");
				asmCodeList.add(";PRINTF");
				asmCodeList.add("L" + (i + 1) + ":");
				asmCodeList.add("lea dx,printf_"+fourElemList.get(i).getArg1()+(i+1));
				...
				asmCodeList.add("lea dx,scanf_"+fourElemList.get(i).getArg1()+(i+1));
				asmCodeList.add("mov ah,9");
				asmCodeList.add("int 21h");
				...
				asmCodeList.add("mov "+fourElemList.get(i).getArg1()+",ax;");
				...
				asmCodeList.add("sub al,30h;");
				asmCodeList.add("add ax,"+fourElemList.get(i).getArg1()+";");
				asmCodeList.add("mov "+fourElemList.get(i).getArg1()+",ax");
